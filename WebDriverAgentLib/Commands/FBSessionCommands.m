...
+ (id<FBResponsePayload>)handleGetSettings:(FBRouteRequest *)request
{
  return FBResponseWithObject(
    @{
      ...
      FB_SETTING_INCLUDE_HITTABLE_IN_SOURCE: @([FBConfiguration includeHittableInSource]),
...
+ (id<FBResponsePayload>)handleSetSettings:(FBRouteRequest *)request
{
  ...
  if (nil != [settings objectForKey:FB_SETTING_INCLUDE_HITTABLE_IN_SOURCE]) {
    [FBConfiguration setIncludeHittableInSource:[[settings objectForKey:FB_SETTING_INCLUDE_HITTABLE_IN_SOURCE] boolValue]];
  }
